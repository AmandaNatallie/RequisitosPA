...
-- Tempo de Geração: 04/12/2015 às 13:33
...
--
-- Banco de dados: `criativi_projetoaplicado`
--
...
INSERT INTO `tbl_categorias` (`id_categoria`, `titulo`) VALUES
(5, 'Beleza'),
(6, 'Dermocosméticos'),
(8, 'Fitness'),
(3, 'Higiene Pessoal'),
...
INSERT INTO `tbl_cidades` (`id_cidade`, `cidade`, `uf`) VALUES
...
INSERT INTO `tbl_clientes` (`id_cliente`, `nome`, `email`, `telefone`, `cpf`, `cidade`, `estado`, `endereco`, `id_usuario`) VALUES
(1, 'Bruno Chagas', 'bruno.chagas@gmail.com', '(31) 2345-5623', '123.123.123.123-45', 'Minas novas', 'Minas Gerais', 'Rua Araxa, nº 94', 36);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tbl_estados`
--
...
--
-- Fazendo dump de dados para tabela `tbl_estados`
--

INSERT INTO `tbl_estados` (`id_estado`, `estado`, `descricao`) VALUES
(1, 'AC', 'Acre'),
(2, 'AL', 'Alagoas'),
(3, 'AP', 'Amapá'),
(4, 'AM', 'Amazonas'),
...
--
-- Estrutura para tabela `tbl_farmacias`
--
...
--
-- Fazendo dump de dados para tabela `tbl_farmacias`
--

INSERT INTO `tbl_farmacias` (`id_farmacia`, `nome`, `cnpj`, `endereco`, `telefone`, `email`, `cidade`, `estado`, `logotipo`, `mapa`) VALUES
(73, 'Drogaria da Esquina', '18.273.619/2379-11', 'Av. Thales Chagas, 1414', '(91) 2731-3773', 'nome@exemplo.com', '310620', 'MG', '3dfea84423bcf6f95fc0584171bbfc15.png', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d644.2432518728863!2d-43.941949483965026!3d-19.91686205360081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x3834cab6bb4fd7e7!2sP%C3%A9rola+Baby!5e0!3m2!1spt-BR!2sbr!4v1448061592921" width="600" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>'),
(74, 'Drogaria Nonô', '38.472.948/7249-83', 'Praça do amparo, Nº 101', '(19) 2837-19837', 'nono@nono.nono', '310620', 'MG', '5703f557315c7f9a2f5370f1128429eb.png', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d644.2432518728863!2d-43.941949483965026!3d-19.91686205360081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x3834cab6bb4fd7e7!2sP%C3%A9rola+Baby!5e0!3m2!1spt-BR!2sbr!4v1448061592921" width="600" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>'),
(75, 'Farmácia Campo Belo', '23.424.984/9128-74', 'Rua Barão do Rio Branco, nº 231, Campo Belo', '(12) 3456-54321', 'contato@campobelo.com.br', '311120', 'MG', 'f4a0b1e8557fbb12700303c78a11bb70.png', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d644.2432518728863!2d-43.941949483965026!3d-19.91686205360081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x3834cab6bb4fd7e7!2sP%C3%A9rola+Baby!5e0!3m2!1spt-BR!2sbr!4v1448061592921" width="600" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>');
...
INSERT INTO `tbl_produtos` (`id_produto`, `nome`, `categoria`, `imagem`, `bula`, `preco`, `fabricante`, `marca`, `composicao`, `id_farmacia`, `keyword`) VALUES
(5, 'Buscopan Composto - 20 Comprimidos Revestidos', 1, 'c17e4b75e12fe63ead62803e6b7e6eb6.jpg', '882eedf4b02bf5d498121ad59ada0162.pdf', '9.05', 'Boehringer Ingelheim', 'Buscopan', 'Butilbrometo de Escopolamina', 73, 'Buscopan'),
(8, 'Batom Maybelline Color Sensational Matte Cor 112 Nunca Fui Santa', 5, 'a24547d21d6f0dabb9da2bb8d78bc3ab.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '27.05', 'Maybelline', 'Maybelline', 'Silica; Tocopheryl Acetate; Peg-5 Rapeseed Sterol; Disteardimonium Hectorite; Alumina; Calcium Aluminum Borosilicate; Parfum / Fragrance; Pentaerythrityl Tetraisostearate; Synthetic Fluorphlogopite; Propylene Carbonate; Ascorbyl Palmitate; Calcium Sodium ', 74, 'Batom'),
(9, 'Xarope Expectorante Mucofan - 100 Ml Pediátrico', 1, '111c8ceea4812d204dca33ae8f1d6e62.jpg', '09510fa5983fbd0ae1f9d73d476afc42.pdf', '15.65', 'Wyeth', 'Mucofan', 'Carbocisteína Xarope', 73, 'Mucofan'),
(10, 'Centrum com 100 + 30 Comprimidos', 1, '3d81a702d5575a90742ed2aa0f3a1457.jpg', '9212cfd0e3284498a2e0ce1bfab423b6.pdf', '36.73', 'Wyeth', 'Centrum', 'Suplemento de vitaminas e minerais  Colorido artificialmente ', 73, 'Centrum'),
(11, 'Paracetamol 750mg Medley Genérico com 20 Comprimidos', 1, '8f530866fbf053e661e0f7688daf24bc.jpg', 'fb51ea52e3d64143f50c12ab49e9c515.pdf', '8.30', 'Medley', 'Paracetamol', 'PARACETAMOL (750MG)', 73, 'Paracetamol'),
(13, 'Protetor Solar Minesol Oil Control FPS 30 Gel Creme', 5, '94dfa423eee8326fb4f1f62395fb0b00.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '67.90', 'ROC', 'Minesol', 'Aqua, Ethylhexyl Methoxycinnamate, C12-15 Alkyl Benzoate, Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine, Silica, Butylene Glycol, Glycine Soja Seed Extract, Aluminum Starch Octenylsuccinate, Potassium Cetyl Phosphate, Methylene Bis-Benzotriazolyl Tetrame', 74, 'Minesol'),
(14, 'Benegrip Envelope com 6 Comprimidos', 1, '9261ebe684c8765b772039bc9af92ad8.png', '9c8c82bc7de846bf89c41796d7dbe641.pdf', '6.89', 'Hypermarcas', 'Benegrip', 'DIPIRONA SÓDICA MONOIDRATADA (500MG) + CITRATO DE CAFEÍNA (30MG) + MALEATO DE CLORFENIRAMINA (2MG)', 73, 'Benegrip'),
(15, 'Nivea Cellular Antissinais Creme Hidratante Noite', 5, '72931152a5280e72601203791cc58cfc.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '102.55', 'Nivea', 'Nivea', 'Ácido Hialurônico e Extrato de Magnólia', 74, 'Hidratante'),
(16, 'Shampoo + Condicionador Pantene Hidratação com 400ml ', 5, '3439fcbf6655c4164fbb5b8417ab422c.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '25.95', 'Pantene', 'Pantene', '...', 74, 'Shampoo Pantene'),
(17, 'Loção Monange Toque de Carinho para Todo Tipo de Pele', 5, 'ac5cdf8b6570e1b33180dfb2a48dfbd0.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '3.99', 'Monange', 'Monange', 'Óleo de Amêndoas Doce, Extrato de Folha de Aloe Vera, Hidroxietil Uréia', 74, 'Lo&ccedil;&atilde;o'),
(18, 'Leite de Rosas', 6, '08004f98a5b7ca6eff98a23682096989.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '4.59', 'Leite de Rosas', 'Leite de Rosas', 'À base de clorexidine, álcool, óxido de zinco e cloreto de benzalcônio', 74, 'Leite de Rosas'),
(19, 'Figatil com 20 Drágeas', 1, '3e9b4eb42b2502a2176b93a4ec405341.jpg', '3f08e7753da0a19d8fd8eecfb4a5be43.pdf', '23.23', 'Catarinense', 'Figatil', 'PEUMUS BOLDUS (69.44MG) + ALCACHOFRA (41.67MG)', 73, 'Figatil'),
(20, 'Lenço Umedecido Asepxia', 6, '9df7da8d09d52766315d3ca14f1555c8.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '24.95', 'Gennoma Lab', 'Asepxia', 'Algodão', 74, 'Len&ccedil;o'),
(22, 'Imecap Redutor de Medidas com 60 Cápsulas + Imecap Redutor de Medidas Creme com 250g', 6, '031bff0e02225a370bddbde453a9a208.jpg', '882eedf4b02bf5d498121ad59ada0162.pdf', '95.67', 'Harold', 'Imecap', ' Cloridrato de Piridoxina (Vit. B6), Biotina, Cromo Quelato, Selenito de Sódio, Zinco Quelato', 75, 'Imecap'),
(23, 'Hipoglós Amêndoas Pomada Contra Assadura', 4, '4f0d420427b4ce9196c34ad30de1a373.jpg', '3fef4e3d005835af9d3789381482e02a.pdf', '17.50', 'P&G ', 'Hipoglós', 'Retinol (vitamina A) - 5.000 UI - Colecalciferol (vitamina D) - 900 UI - Óxido de Zinco - 150 mg - Excipientes q.s.p - 1 g', 73, 'Hipogl&oacute;s'),
(24, 'Acnase Gel de Limpeza Esfoliante', 6, 'd1a260b466910543db7483b62822c22f.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '30.25', 'Avert', 'Acnase', 'Cada g de gel contém: peróxido de benzoíla - 50 mg propilenoglicol, associação de álcoois graxos e emulsificantes não iônicos, coco glicerídeo, éster cáprico caprílico, isononanoato de cetoestearila, sclerotium gum, goma xantana, metilparabeno, propilpara', 74, 'Acnase'),
(25, 'Neutrogerm 0,5% Sabonete Líquido', 6, '50d2fa8159dc37ef353457ee5336e215.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '15.10', 'Hertz', 'Neutrogerm', '0,5% de Tricosano (gel de limpeza/150 ml e sabonete em barra com base vegetal /70g)', 74, 'Neutrogerm'),
(26, 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso com 50g', 4, '8fa9fc639c2dda2773abab3f12e2b53e.jpg', '1750ac87f755fc509d047223b65d214e.pdf', '4.49', 'Tandy', 'Tandy', 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso', 73, 'Tandy'),
(27, 'Leite de Colônia Original com 100ml', 6, '613cd2844ec2aa3d64ae63a5589d4dea.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '3.19', 'Leite de Colônia', 'Leite de Colônia', 'Alcool e essência desodorante', 74, 'Leite de Colonia'),
(28, 'Fralda Huggies Primeiros 100 Dias Tamanho P', 4, 'f5ab1905350fa21d14a389bf42db16bb.jpg', 'ce86af43be5ef0b9e6f1bca4dfc45755.pdf', '28.15', 'Huggies', 'Huggies', 'Com indicador de umidade - Barreiras anti-vazamento - Cintura elástica - Dermatologicamente testado', 73, 'Fralda'),
(29, 'Sabonete Líquido Infantil Glicerina Granado Bebê com 250ml', 4, '624883cacb7df6528d14481c9ab54e03.jpg', 'e41e42b3db5035fef73a593d2cc43574.pdf', '13.99', 'Granado', 'Granado', 'Sodium lauryl sulfate, TEA-Cocoyl glutamate, decyl glucoside, cocamidopropyl betaine', 73, 'Sabonete'),
(30, 'Desitin Creamy Creme Contra Assadura com 57g', 4, '47f10a7e217598aba85b1e0e00887459.jpg', 'ec8b13b35c54c393a2b4228da7f2e25c.pdf', '19.99', 'Johnson & Johnson', 'Johnson & Johnson', 'Zinc Oxide 13% Aloe Barbadensis Leaf Juice Beeswax Dimethicone Fragrance Magnesium Sulfate Methylparaben Microcrystalline Wax Mineral Oil PEG-30 Dipolyhydroxystearate Petrolatum Phenoxyethanol Potassium Hydroxide Propylparaben Sorbitan Sesquioleate Tocoph', 73, 'Hipogl&oacute;s'),
(31, 'Gatorade Sabores 500ML', 8, '9026f648f7fb3599054c11889e125040.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '3.00', 'Gatorade', 'Gatorade', 'Sacarose, Água, Glicose, Sal cloreto de sódio, Citrato de Sódio, Fosfato de potássio monobásico, Acidulante Ácido Cítrico, Aromatizante', 74, 'Gatorade'),
(32, 'Chá Verde Sanavita Sabor Frutas Cítricas 250g', 8, 'acbe4a720543b70010bc8b3f1579a7e8.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '41.75', 'Sanavita', 'Sanavita', 'Camellia sinensis concentrada em pó e alto teor de polifenóis', 74, 'Chá'),
(33, 'Semente Chia Excelência', 8, '9732577815592d4c9f3c6ec801c51229.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '12.99', 'Viver Bem Produtos Naturais', 'Sementes de Chia', 'Sementes de Chia', 74, 'Chia'),
(34, 'Barra de Cereais Nutry Aveia, Banana e Mel com 4 Unidades Leve 4 Pague 3', 8, 'dfa1cc34d22c93953c65d971914a883a.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '2.48', 'Nutry', 'Nutry', 'Aveia, Banana e Mel', 74, 'Barra de Cereais'),
(35, 'Dersani Hidrogel Alginato 85g', 9, 'fbc7dd061370e096c0c40a5659c2da01.jpg', '48dd11c172c78c5f0f9ca6ec1f6a6054.pdf', '64.30', 'Dersani', 'Dersani Hidrogel', 'GEL HIDRATANTE ABSORVENTE, ESTÉRIL À BASE DE A.G.E. E VITAMINAS A E E', 73, 'Hidrogel'),
(36, 'Dilatador Nasal Respire Melhor Normal com 10 Tiras', 8, 'e82b878b7e6b1e5423daa93966185404.jpg', '2aaeb056c6b876a2994b965908d1d5a7.pdf', '23.45', 'Respire Melhor', 'Respire Melhor', 'N A', 74, 'Dilatador Nasal'),
(37, 'Dersidrat Loção Oleosa Hidratante com 200ml', 9, '5215da741b9e6d59adc4824ea3ad3793.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '59.90', 'Dersani', 'Dersidrat Loção Oleosa', 'Dersidrat Loção Oleosa Hidratante', 73, 'Hidratante'),
(38, 'Geriaderm Pomada Contra Assadura com 120g', 9, '573ad65d6d52a150688f52926270a137.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '13.85', 'Geriaderm', 'Geriaderm', 'Vitamina A 100.000 UI/100g, vitamina D 40.000 UI/100g, 10% óxido de zinco.', 73, 'Hipogl&oacute;s'),
(39, 'Nutren Senior com 370g', 9, '28b33159cbb3ecda6e8b4db45372df1e.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '46.60', 'Nutren', 'Nestlé', 'Contém ACT-3, combinação única de cálcio, proteína e vitamina D', 73, 'Nutren'),
(40, 'Fralda Geriátrica AdultMax Maturidade Tamanho Único com 10 Unidades', 9, 'a55b1008dc75cdca2c03262706637eb6.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '14.65', 'AdultMax ', 'AdultMax ', 'Fralda Geriátrica AdultMax Maturidade', 73, 'Fralda'),
(41, 'Bravecto Contra Pulgas e Carrapatos para Cães entre 20 e 40kg com 1 Comprimido Mastigável', 7, '1dde5f4b3d2f8d5ce6186cdce3a37159.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '209.90', 'Bravecto', 'Bravecto', 'Comprimidos mastigáveis à base de fluralaner. Dose única.', 73, 'Anti-pulga'),
(42, 'Bactrovet Prata AM Uso Veterinário Aerosol com 500ml', 7, '2343c4157711b417717341e343463dc9.jpg', '319d1cae8cd31ea92ad8c025a21a34ef.pdf', '25.50', 'Kong', 'Kong', 'Larvicida - Bernicida - Repelente - Cicatrizante - Antisséptico - Alta Aderência', 73, 'Bactrovet'),
(43, 'Biscoito para Cão Pedigree Biscrok Júnior com 300g', 7, '56e96d4a50458b6035e81588eac27ad9.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '9.50', 'Pedigreea', 'Pedigree', 'Farinha de trigo, quirera de arroz, farinha de vísceras, gordura de frango, glúten de trigo, leite integral em pó (0,4%), farinha de aveia, farinha de centeio, milho integral moído*, vitaminas (B1, D3, E, cloreto de colina), minerais (cloreto de sódio (sa', 73, 'Biscoito'),
(44, 'K-Othrine Frasco com 30ml', 7, '0079892d0107d3710d7574f5ca212dad.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '10.55', 'K-Othrine', 'K-Othrine', '(S)-a-cyano-3-phenoxybenzyl (1R,3R)-3-(2,2-dibromovinyl)- 2,2-dimethylcyclopropanecarboxylate', 73, 'K-Othrine'),
(45, 'Monovin A Injetável Uso Veterinário 1 Frasco Ampola de 20ml', 7, '0ccb53fdec25df7b6cf3ec99cb76dbc0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '32.90', 'Monovin', 'Monovin', 'Vitaminas (Formulações Puras E Complexos).', 73, 'Monovin'),
(47, 'Buscopan Composto - 20 Comprimidos Revestidos', 1, 'c17e4b75e12fe63ead62803e6b7e6eb6.jpg', '882eedf4b02bf5d498121ad59ada0162.pdf', '9.05', 'Boehringer Ingelheim', 'Buscopan', 'Butilbrometo de Escopolamina', 75, 'Buscopan'),
(48, 'Absorvente Intimus Gel Tripla Proteção Cobertura Suave Com Abas com 8 Unidades', 3, 'cbba441ccbc05470da825be782adc482.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '3.35', 'Intimus', 'Intimus', 'N A', 73, 'Absorvente'),
(49, 'Carga Gillette Mach3 Sensitive com 4 Unidades', 3, 'a32dc5cfe085120b7ed77a6723e0dce0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '30.20', 'Gilette', 'Mach3', 'N A ', 73, 'GILLETE'),
(50, 'Creme Dental Colgate Luminous White + Oferta com 3 Unidades Creme Dental de 90g cada + Enxaguante Bucal Luminous White com 250ml', 3, '1d81d42ce0d52896e7556973ea47e13d.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '10.99', 'Colgate', 'Colgate', 'N A ', 73, 'Creme Dental'),
(51, 'Creme de Pentear Dove Men + Care Força e Controle com 200ml', 3, 'ab7031627c826bc5ead4cff8a34df839.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '10.95', 'Dove', 'Dove Men + Care Força', 'AQUA, PARAFFINUM LIQUIDUM, CETEARYL ALCOHOL, GLYCERIN, DIMETHICONE, STEARAMIDOPROPYL, DIMETHYLAMINE, PARFUM, CYCLOPENTASILOXANE, TRIMETHYLSILOXYSLICATE, DIMETHICONOL, DIMETHYLACRYLAMIDE/ETHYLTRIMONIUM CHLORIDE METHACYLATE COPOLYMER, DMDM HYDANTOIN, LACTIC', 73, 'Creme Pentear'),
(52, 'Condicionador Seda Pretos Luminosos com 350ml', 3, '22f175996ef7fda4fe0eb64436521808.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '5.99', 'UNILEVER', 'Seda', 'N A ', 73, 'condicionador'),
(53, 'Condicionador Seda Pretos Luminosos com 350ml', 3, '22f175996ef7fda4fe0eb64436521808.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '6.20', 'UNILEVER', 'Seda', 'N A ', 74, 'condicionador'),
(54, 'Creme de Pentear Dove Men + Care Força e Controle com 200ml', 3, 'ab7031627c826bc5ead4cff8a34df839.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '10.50', 'Dove', 'Dove Men + Care Força', 'AQUA, PARAFFINUM LIQUIDUM, CETEARYL ALCOHOL, GLYCERIN, DIMETHICONE, STEARAMIDOPROPYL, DIMETHYLAMINE, PARFUM, CYCLOPENTASILOXANE, TRIMETHYLSILOXYSLICATE, DIMETHICONOL, DIMETHYLACRYLAMIDE/ETHYLTRIMONIUM CHLORIDE METHACYLATE COPOLYMER, DMDM HYDANTOIN, LACTIC', 74, 'Creme pentear'),
(55, 'Creme Dental Colgate Luminous White + Oferta com 3 Unidades Creme Dental de 90g cada + Enxaguante Bucal Luminous White com 250ml', 3, '1d81d42ce0d52896e7556973ea47e13d.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '11.20', 'Colgate', 'Colgate', 'N A ', 74, 'Creme dental'),
(56, 'Carga Gillette Mach3 Sensitive com 4 Unidades', 3, 'a32dc5cfe085120b7ed77a6723e0dce0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '30.50', 'Gilette', 'Mach3', 'N A ', 74, 'Gillete'),
(57, 'Absorvente Intimus Gel Tripla Proteção Cobertura Suave Com Abas com 8 Unidades', 3, 'cbba441ccbc05470da825be782adc482.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '3.25', 'Intimus', 'Intimus', 'N A ', 74, 'Absorvente'),
(65, 'Dersani Hidrogel Alginato 85g', 9, 'fbc7dd061370e096c0c40a5659c2da01.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '60.00', 'Dersani', 'Dersani Hidrogel', 'GEL HIDRATANTE ABSORVENTE, ESTÉRIL À BASE DE A.G.E. E VITAMINAS A E E', 74, 'Hidrogel'),
(66, 'Dersidrat Loção Oleosa', 9, '5215da741b9e6d59adc4824ea3ad3793.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '56.10', 'Dersani', 'Dersani Loção', 'Dersidrat Loção Oleosa', 74, 'Oleo loçao'),
(67, 'Geriaderm Pomada Contra Assadura com 120g', 9, '573ad65d6d52a150688f52926270a137.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '15.60', 'Geriaderm', 'Geriaderm', 'Vitamina A 100.000 UI/100g, vitamina D 40.000 UI/100g, 10% óxido de zinco.', 74, 'Pomada'),
(68, 'Nutren Senior com 370g', 9, '28b33159cbb3ecda6e8b4db45372df1e.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '49.90', 'Nutren Senior ', 'Nestlé', 'Contém ACT-3, combinação única de cálcio, proteína e vitamina D', 74, 'Nutren'),
(69, 'Fralda Geriátrica AdultMax Maturidade Tamanho Único com 10 Unidades', 9, 'a55b1008dc75cdca2c03262706637eb6.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '15.10', 'AdultMax', 'AdultMax', 'Fralda Geriátrica AdultMax Maturidade', 74, 'Fralda'),
(70, 'Buscopan Composto - 20 Comprimidos Revestidos', 1, 'c17e4b75e12fe63ead62803e6b7e6eb6.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '7.80', 'Boehringer', 'Buscopan', 'Comprimidos revestidos Cada comprimido revestido contém 10 mg de butilbrometo de escopolamina, correspondentes a 6,89 mg de escopolamina e 250 mg de dipirona sódica, correspondentes a 233,64 mg de dipirona. Excipientes: dióxido de silício, povidona, lacto', 74, 'Buscopan'),
(71, 'Benegrip Envelope com 6 Comprimidos', 1, '9261ebe684c8765b772039bc9af92ad8.png', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '8.90', 'Hypermarcas', 'Benegrip', 'Dipirona sódica 250,0 mg - Maleato de clorfeniramina 2,0 mg - excipientes* q.s.p 1 comprimido revestido', 74, 'Benegrip'),
(72, 'Xarope Expectorante Mucofan - 100 Ml Pediátrico', 1, '111c8ceea4812d204dca33ae8f1d6e62.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '13.00', 'Mucofan', 'Mucofan', 'CARBOCISTEÍNA (50MG/1ML)', 74, 'Xarope'),
(73, 'Paracetamol 750mg Medley Genérico com 20 Comprimidos', 1, '8f530866fbf053e661e0f7688daf24bc.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '7.05', 'Medley', 'Paracetamol', 'PARACETAMOL (750MG)', 74, 'Paracetamol'),
(74, 'Centrum com 100 + 30 Comprimidos', 1, '3d81a702d5575a90742ed2aa0f3a1457.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '33.00', 'Wyeth', 'Centrum', 'Suplemento de vitaminas e minerais  Colorido artificialmente ', 74, 'Centrum'),
(75, 'Figatil com 20 Drágeas', 1, '3e9b4eb42b2502a2176b93a4ec405341.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '25.00', 'Boehringer', 'Buscopan', 'N A', 74, 'Figatil'),
(76, 'Hipoglós Amêndoas Pomada Contra Assadura com 40g', 4, '4f0d420427b4ce9196c34ad30de1a373.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '15.00', 'P&G', 'HIPOGLÓS', 'Retinol (vitamina A) - 5.000 UI - Colecalciferol (vitamina D) - 900 UI - Óxido de Zinco - 150 mg - Excipientes q.s.p - 1 g', 74, 'Pomada'),
(77, 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso com 50g', 4, '8fa9fc639c2dda2773abab3f12e2b53e.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '6.10', 'Tandy', 'Tandy', 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso ', 74, 'Creme Dental'),
(78, 'Fralda Huggies Primeiros 100 Dias Tamanho P Pacote Jumbo com 36 Fraldas Descartáveis', 4, 'f5ab1905350fa21d14a389bf42db16bb.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '25.50', 'Huggies', 'Huggies', 'Com indicador de umidade - Barreiras anti-vazamento - Cintura elástica - Dermatologicamente testado', 74, 'Fralda'),
(79, 'Sabonete Líquido Infantil Glicerina Granado Bebê com 250ml', 4, '624883cacb7df6528d14481c9ab54e03.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '11.49', 'Granado', 'Granado', 'Sodium lauryl sulfate, TEA-Cocoyl glutamate, decyl glucoside, cocamidopropyl betaine', 74, 'sabonete'),
(80, 'Desitin Creamy Creme Contra Assadura com 57g', 4, '47f10a7e217598aba85b1e0e00887459.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '21.30', 'Johnson & Johnson', 'Johnson & Johnson', 'Zinc Oxide 13% - Aloe Barbadensis Leaf Juice – Beeswax - Dimethicone Fragrance - Magnesium Sulfate – Methylparaben - Microcrystalline Wax Mineral Oil - PEG-30 Dipolyhydroxystearate - Petrolatum Phenoxyethanol - Potassium Hydroxide – Propylparaben - Sorbit', 74, 'Pomada'),
(81, 'Bravecto Contra Pulgas e Carrapatos para Cães entre 20 e 40kg com 1 Comprimido Mastigável', 7, '1dde5f4b3d2f8d5ce6186cdce3a37159.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '190.00', 'Bravecto', 'Bravecto', 'Comprimidos mastigáveis à base de fluralaner. Dose única.', 74, 'anti-pulgas'),
(82, 'Bactrovet Prata AM Uso Veterinário Aerosol com 500ml', 7, '2343c4157711b417717341e343463dc9.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '21.90', 'Kong', 'Kong', 'Larvicida - Bernicida - Repelente - Cicatrizante - Antisséptico - Alta Aderência', 74, 'bactrovet'),
(83, 'Biscoito para Cão Pedigree Biscrok Júnior com 300g', 7, '56e96d4a50458b6035e81588eac27ad9.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '11.00', 'Pedigreea', 'Pedigreea', 'Farinha de trigo, quirera de arroz, farinha de vísceras, gordura de frango, glúten de trigo, leite integral em pó (0,4%), farinha de aveia, farinha de centeio, milho integral moído*, vitaminas (B1, D3, E, cloreto de colina), minerais (cloreto de sódio (sa', 74, 'biscoito'),
(84, 'K-Othrine Frasco com 30ml', 7, '0079892d0107d3710d7574f5ca212dad.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '7.20', 'K-Othrine', 'K-Othrine', '(S)-a-cyano-3-phenoxybenzyl (1R,3R)-3-(2,2-dibromovinyl)- 2,2-dimethylcyclopropanecarboxylate', 74, 'K-Othorine'),
(85, 'Monovin A Injetável Uso Veterinário 1 Frasco Ampola de 20ml', 7, '0ccb53fdec25df7b6cf3ec99cb76dbc0.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '29.90', 'Monovin', 'Monovin', 'Vitaminas (Formulações Puras E Complexos).', 74, 'Monovin'),
(86, 'Batom Maybelline Color Sensational Matte Cor 112 Nunca Fui Santa', 5, 'a24547d21d6f0dabb9da2bb8d78bc3ab.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '25.20', 'Maybelline', 'Maybelline', 'Silica; Tocopheryl Acetate; Peg-5 Rapeseed Sterol; Disteardimonium Hectorite; Alumina; Calcium Aluminum Borosilicate; Parfum / Fragrance; Pentaerythrityl Tetraisostearate; Synthetic Fluorphlogopite; Propylene Carbonate; Ascorbyl Palmitate; Calcium Sodium ', 73, 'Batom MAybelline'),
(87, 'Protetor Solar Minesol Oil Control FPS 30 Gel Creme', 5, '94dfa423eee8326fb4f1f62395fb0b00.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '61.00', 'ROC', 'Minesol', 'Aqua, Ethylhexyl Methoxycinnamate, C12-15 Alkyl Benzoate, Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine, Silica, Butylene Glycol, Glycine Soja Seed Extract, Aluminum Starch Octenylsuccinate, Potassium Cetyl Phosphate, Methylene Bis-Benzotriazolyl Tetrame', 73, 'Protetor solar'),
(88, 'Nivea Cellular Antissinais Creme Hidratante Noite', 5, '72931152a5280e72601203791cc58cfc.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '111.00', 'Nivea', 'Nivea', 'Ácido Hialurônico e Extrato de Magnólia', 73, 'nivea Cellular'),
(89, 'Shampoo + Condicionador Pantene Hidratação com 400ml', 5, '3439fcbf6655c4164fbb5b8417ab422c.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '22.00', 'Pantene', 'Pantene', 'N A', 73, 'Condicionador'),
(90, 'Loção Monange Toque de Carinho para Todo Tipo de Pele', 5, 'ac5cdf8b6570e1b33180dfb2a48dfbd0.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '6.50', 'Monange', 'Monange', 'Óleo de Amêndoas Doce, Extrato de Folha de Aloe Vera, Hidroxietil Uréia', 73, 'loçao monange'),
(91, 'Acnase Gel de Limpeza Esfoliante', 6, 'd1a260b466910543db7483b62822c22f.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '29.40', 'Avert', 'Acnase', 'Cada g de gel contém: peróxido de benzoíla - 50 mg propilenoglicol, associação de álcoois graxos e emulsificantes não iônicos, coco glicerídeo, éster cáprico caprílico, isononanoato de cetoestearila, sclerotium gum, goma xantana, metilparabeno, propilpara', 73, 'esfoliante'),
(92, 'Leite de Rosas', 6, '08004f98a5b7ca6eff98a23682096989.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '5.10', 'Leite de Rosas', 'Leite de Rosas', 'à base de clorexidine, álcool, óxido de zinco e cloreto de benzalcônio', 73, 'Leite de rosas'),
(93, 'Lenço Umedecido Asepxia', 6, '9df7da8d09d52766315d3ca14f1555c8.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '22.05', 'Asepxia', 'Asepxia', 'Algodão', 73, 'Lenço'),
(94, 'Neutrogerm 0,5% Sabonete Líquido', 6, '50d2fa8159dc37ef353457ee5336e215.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '13.00', 'Hertz', 'Neutrogerm', '0,5% de Tricosano (gel de limpeza/150 ml e sabonete em barra com base vegetal /70g)', 73, 'Neutrogerm'),
(95, 'Leite de Colônia Original com 100ml', 6, '613cd2844ec2aa3d64ae63a5589d4dea.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '3.55', 'Leite de Colônia', 'Leite de Colônia', 'Alcool e essência desodorante', 73, 'leite de colonia'),
(96, 'Gatorade', 8, '9026f648f7fb3599054c11889e125040.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '4.20', 'Gatorade', 'Gatorade', 'Sacarose, Água, Glicose, Sal cloreto de sódio, Citrato de Sódio, Fosfato de potássio monobásico, Acidulante Ácido Cítrico, Aromatizante', 73, 'gatorade'),
(97, 'Chá Verde Sanavita Sabor Frutas Cítricas 250g', 8, 'acbe4a720543b70010bc8b3f1579a7e8.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '45.20', 'Sanavita', 'Sanavita', 'Camellia sinensis concentrada em pó e alto teor de polifenóis', 73, 'Chá'),
(98, 'Semente Chia Excelência', 8, '9732577815592d4c9f3c6ec801c51229.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '10.20', 'Viver Bem Produtos Naturais', 'Sementes de Chia', 'Sementes de Chia', 73, 'Chia'),
(99, 'Barra de Cereais Nutry Aveia, Banana e Mel com 4 Unidades Leve 4 Pague 3', 8, 'dfa1cc34d22c93953c65d971914a883a.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '3.10', 'Nutry', 'Nutry', 'Aveia, Banana e Mel', 73, 'barra cereais'),
(100, 'Dilatador Nasal Respire Melhor Normal com 10 Tiras', 8, 'e82b878b7e6b1e5423daa93966185404.jpg', 'c07cddf16c8b9aa01d07e43857af6c2e.pdf', '20.00', 'Respire Melhor', 'Respire Melhor', 'N A', 73, 'Dilatador nasal'),
(101, 'Absorvente Intimus Gel Tripla Proteção Cobertura Suave Com Abas com 8 Unidades', 3, 'cbba441ccbc05470da825be782adc482.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '4.30', 'Intimus', 'Intimus', 'N A', 75, 'Absorvente'),
(102, 'Carga Gillette Mach3 Sensitive com 4 Unidades', 3, 'a32dc5cfe085120b7ed77a6723e0dce0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '34.15', 'Gilette', 'Mach3', 'N A ', 75, 'Gillete'),
(103, 'Creme Dental Colgate Luminous White + Oferta com 3 Unidades Creme Dental de 90g cada + Enxaguante Bucal Luminous White com 250ml', 3, '1d81d42ce0d52896e7556973ea47e13d.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '14.41', 'Colgate', 'Colgate', 'N A', 75, 'Creme dental'),
(104, 'Creme Dental Colgate Luminous White + Oferta com 3 Unidades Creme Dental de 90g cada + Enxaguante Bucal Luminous White com 250ml', 3, 'd41d8cd98f00b204e9800998ecf8427e.jpg', 'd41d8cd98f00b204e9800998ecf8427e.pdf', '14.41', 'Colgate', 'Colgate', 'N A', 75, 'Creme dental'),
(105, 'Creme de Pentear Dove Men + Care Força e Controle com 200ml', 3, 'ab7031627c826bc5ead4cff8a34df839.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '14.75', 'Dove', 'Dove Men + Care Força', 'AQUA, PARAFFINUM LIQUIDUM, CETEARYL ALCOHOL, GLYCERIN, DIMETHICONE, STEARAMIDOPROPYL, DIMETHYLAMINE, PARFUM, CYCLOPENTASILOXANE, TRIMETHYLSILOXYSLICATE, DIMETHICONOL, DIMETHYLACRYLAMIDE/ETHYLTRIMONIUM CHLORIDE METHACYLATE COPOLYMER, DMDM HYDANTOIN, LACTIC', 75, 'Creme pentear'),
(106, 'Condicionador Seda Pretos Luminosos com 350ml', 3, '22f175996ef7fda4fe0eb64436521808.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '5.00', 'UNILEVER', 'Seda', 'N A', 75, 'condicionador '),
(107, 'Benegrip Envelope com 6 Comprimidos', 1, '9261ebe684c8765b772039bc9af92ad8.png', 'a2ddfa37294a7d910190602e0c86c794.pdf', '15.10', 'Hypermarcas', 'Benegrip', 'Dipirona sódica 250,0 mg - Maleato de clorfeniramina 2,0 mg - excipientes* q.s.p 1 comprimido revestido', 75, 'Benegrip'),
(109, 'Paracetamol 750mg Medley Genérico com 20 Comprimidos', 1, '8f530866fbf053e661e0f7688daf24bc.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '7.10', 'Medley', 'Paracetamol', 'PARACETAMOL (750MG)', 75, 'Paracetamol'),
(110, 'Centrum com 100 + 30 Comprimidos', 1, '3d81a702d5575a90742ed2aa0f3a1457.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '41.20', 'Wyeth', 'Centrum', 'Suplemento de vitaminas e minerais  Colorido artificialmente ', 75, 'centrum'),
(111, 'Figatil com 20 Drágeas', 1, '3e9b4eb42b2502a2176b93a4ec405341.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '24.10', 'Catarinense', 'Figatil', 'PEUMUS BOLDUS (69.44MG) + ALCACHOFRA (41.67MG)', 75, 'Figatil'),
(112, 'Hipoglós Amêndoas Pomada Contra Assadura com 40g', 4, '4f0d420427b4ce9196c34ad30de1a373.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '21.35', 'P&G', 'HIPOGLÓS', 'Retinol (vitamina A) - 5.000 UI - Colecalciferol (vitamina D) - 900 UI - Óxido de Zinco - 150 mg - Excipientes q.s.p - 1 g', 75, 'Pomada'),
(113, 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso com 50g', 4, '8fa9fc639c2dda2773abab3f12e2b53e.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '7.20', 'Tandy', 'Tandy', 'Gel Dental Infantil Tandy com Flúor Ativo Sabor Morangostoso ', 75, 'Creme dental'),
(114, 'Fralda Huggies Primeiros 100 Dias Tamanho P Pacote Jumbo com 36 Fraldas Descartáveis', 4, 'f5ab1905350fa21d14a389bf42db16bb.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '25.35', 'Huggies', 'Huggies', 'Com indicador de umidade - Barreiras anti-vazamento - Cintura elástica - Dermatologicamente testado', 75, 'Fralda'),
(115, 'Sabonete Líquido Infantil Glicerina Granado Bebê com 250ml', 4, '624883cacb7df6528d14481c9ab54e03.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '16.05', 'Granado', 'Granado', 'Sodium lauryl sulfate, TEA-Cocoyl glutamate, decyl glucoside, cocamidopropyl betaine', 75, 'sabonete'),
(116, 'Desitin Creamy Creme Contra Assadura com 57g', 4, '47f10a7e217598aba85b1e0e00887459.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '23.15', 'Johnson & Johnson', 'Johnson & Johnson', 'Zinc Oxide 13% - Aloe Barbadensis Leaf Juice – Beeswax - Dimethicone Fragrance - Magnesium Sulfate – Methylparaben - Microcrystalline Wax Mineral Oil - PEG-30 Dipolyhydroxystearate - Petrolatum Phenoxyethanol - Potassium Hydroxide – Propylparaben - Sorbit', 75, 'POmada assadura'),
(117, 'Batom Maybelline Color Sensational Matte Cor 112 Nunca Fui Santa', 5, 'a24547d21d6f0dabb9da2bb8d78bc3ab.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '23.50', 'Maybelline', 'Maybelline', 'Silica; Tocopheryl Acetate; Peg-5 Rapeseed Sterol; Disteardimonium Hectorite; Alumina; Calcium Aluminum Borosilicate; Parfum / Fragrance; Pentaerythrityl Tetraisostearate; Synthetic Fluorphlogopite; Propylene Carbonate; Ascorbyl Palmitate; Calcium Sodium ', 75, 'batom maybelline'),
(118, 'Protetor Solar Minesol Oil Control FPS 30 Gel Creme', 5, '94dfa423eee8326fb4f1f62395fb0b00.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '70.00', 'ROC', 'Minesol', 'Aqua, Ethylhexyl Methoxycinnamate, C12-15 Alkyl Benzoate, Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine, Silica, Butylene Glycol, Glycine Soja Seed Extract, Aluminum Starch Octenylsuccinate, Potassium Cetyl Phosphate, Methylene Bis-Benzotriazolyl Tetrame', 75, 'Protetor solar'),
(119, 'Nivea Cellular Antissinais Creme Hidratante Noite', 5, '72931152a5280e72601203791cc58cfc.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '95.25', 'Nivea', 'Nivea', 'Ácido Hialurônico e Extrato de Magnólia', 75, 'Hidratante'),
(120, 'Shampoo + Condicionador Pantene Hidratação com 400ml', 5, '3439fcbf6655c4164fbb5b8417ab422c.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '21.35', 'Pantene', 'Pantene', 'N A', 75, 'condicionador'),
(121, 'Loção Monange Toque de Carinho para Todo Tipo de Pele', 5, 'ac5cdf8b6570e1b33180dfb2a48dfbd0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '6.20', 'Monange', 'Monange', 'Óleo de Amêndoas Doce, Extrato de Folha de Aloe Vera, Hidroxietil Uréia', 75, 'hidratante'),
(122, 'Acnase Gel de Limpeza Esfoliante', 6, 'd1a260b466910543db7483b62822c22f.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '36.75', 'Avert', 'Acnase', 'Cada g de gel contém: peróxido de benzoíla - 50 mg propilenoglicol, associação de álcoois graxos e emulsificantes não iônicos, coco glicerídeo, éster cáprico caprílico, isononanoato de cetoestearila, sclerotium gum, goma xantana, metilparabeno, propilpara', 75, 'gel esfoliante'),
(123, 'Leite de Rosas', 6, '08004f98a5b7ca6eff98a23682096989.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '5.30', 'Leite de Rosas', 'Leite de Rosas', 'à base de clorexidine, álcool, óxido de zinco e cloreto de benzalcônio', 75, 'leite de rosas'),
(124, 'Lenço Umedecido Asepxia', 6, '9df7da8d09d52766315d3ca14f1555c8.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '22.10', 'Asepxia', 'Asepxia', 'Algodão', 75, 'Lenço Umedecido'),
(125, 'Neutrogerm 0,5% Sabonete Líquido', 6, '50d2fa8159dc37ef353457ee5336e215.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '18.25', 'Hertz', 'Neutrogerm', '0,5% de Tricosano (gel de limpeza/150 ml e sabonete em barra com base vegetal /70g)', 75, 'Neutrogem'),
(126, 'Leite de Colônia Original com 100ml', 6, '613cd2844ec2aa3d64ae63a5589d4dea.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '2.25', 'Leite de Colônia', 'Leite de Colônia', 'Alcool e essência desodorante', 75, 'leite de colonia'),
(127, 'Bravecto Contra Pulgas e Carrapatos para Cães entre 20 e 40kg com 1 Comprimido Mastigável', 7, '1dde5f4b3d2f8d5ce6186cdce3a37159.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '202.35', 'Bravecto', 'Bravecto', 'Comprimidos mastigáveis à base de fluralaner. Dose única.', 75, 'anti-pulgas'),
(128, 'Bactrovet Prata AM Uso Veterinário Aerosol com 500ml', 7, '2343c4157711b417717341e343463dc9.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '26.50', 'Kong', 'Kong', 'Larvicida - Bernicida - Repelente - Cicatrizante - Antisséptico - Alta Aderência', 75, 'bactrovect'),
(129, 'Biscoito para Cão Pedigree Biscrok Júnior com 300g', 7, '56e96d4a50458b6035e81588eac27ad9.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '13.55', 'Pedigreea', 'Pedigreea', 'Farinha de trigo, quirera de arroz, farinha de vísceras, gordura de frango, glúten de trigo, leite integral em pó (0,4%), farinha de aveia, farinha de centeio, milho integral moído*, vitaminas (B1, D3, E, cloreto de colina), minerais (cloreto de sódio (sa', 75, 'Biscoito'),
(131, 'K-Othrine Frasco com 30ml', 7, '0079892d0107d3710d7574f5ca212dad.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '13.10', 'K-Othrine', 'K-Othrine', '(S)-a-cyano-3-phenoxybenzyl (1R,3R)-3-(2,2-dibromovinyl)- 2,2-dimethylcyclopropanecarboxylate', 75, 'k-othorine'),
(132, 'Monovin A Injetável Uso Veterinário 1 Frasco Ampola de 20ml', 7, '0ccb53fdec25df7b6cf3ec99cb76dbc0.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '34.90', 'Monovin', 'Monovin', 'Vitaminas (Formulações Puras E Complexos).', 75, 'Monovin'),
(133, 'Gatorade', 8, '9026f648f7fb3599054c11889e125040.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '3.60', 'Gatorade', 'Gatorade', 'Sacarose, Água, Glicose, Sal cloreto de sódio, Citrato de Sódio, Fosfato de potássio monobásico, Acidulante Ácido Cítrico, Aromatizante', 75, 'gatorade'),
(134, 'Chá Verde Sanavita Sabor Frutas Cítricas 250g', 8, 'acbe4a720543b70010bc8b3f1579a7e8.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '48.00', 'Sanavita', 'Sanavita', 'Camellia sinensis concentrada em pó e alto teor de polifenóis', 75, 'cha verde'),
(135, 'Semente Chia Excelência', 8, '9732577815592d4c9f3c6ec801c51229.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '13.10', 'Viver Bem Produtos Naturais', 'Sementes de Chia', 'Sementes de Chia', 75, 'chia'),
(136, 'Barra de Cereais Nutry Aveia, Banana e Mel com 4 Unidades Leve 4 Pague 3', 8, 'dfa1cc34d22c93953c65d971914a883a.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '3.50', 'Nutry', 'Nutry', 'Aveia, Banana e Mel', 75, 'barra de cereais'),
(137, 'Dersani Hidrogel Alginato 85g', 9, 'fbc7dd061370e096c0c40a5659c2da01.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '62.10', 'Dersani', 'Dersani Hidrogel', 'GEL HIDRATANTE ABSORVENTE, ESTÉRIL À BASE DE A.G.E. E VITAMINAS A E E', 75, 'dersani'),
(138, 'Dersidrat Loção Oleosa', 9, '5215da741b9e6d59adc4824ea3ad3793.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '53.20', 'Dersani', 'Dersani Loção', 'Dersidrat Loção Oleosa', 75, 'loçao'),
(139, 'Geriaderm Pomada Contra Assadura com 120g', 9, '573ad65d6d52a150688f52926270a137.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '11.65', 'Geriaderm', 'Geriaderm', 'Vitamina A 100.000 UI/100g, vitamina D 40.000 UI/100g, 10% óxido de zinco.', 75, 'Pomada'),
(140, 'Fralda Geriátrica AdultMax Maturidade Tamanho Único com 10 Unidades', 9, 'a55b1008dc75cdca2c03262706637eb6.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '16.35', 'AdultMax', 'AdultMax', 'Fralda Geriátrica AdultMax Maturidade', 75, 'fralda'),
(141, 'Nutren Senior com 370g', 9, '28b33159cbb3ecda6e8b4db45372df1e.jpg', 'a2ddfa37294a7d910190602e0c86c794.pdf', '53.00', 'Nutren Senior ', 'Nestlé', 'Contém ACT-3, combinação única de cálcio, proteína e vitamina D', 75, 'Nutren'),
(142, 'Shampoo', 3, 'daa76d2e1148f607337cf6b24e5663d7.png', 'N.a', '13.22', 'Johnsons', 'Johnsons', 'x+1=2', 73, ''),
(152, 'rivotril', 1, NULL, NULL, '1.75', 'roche', 'roche', 'rivotridina', 73, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tbl_tipousuario`
--
...
--
-- Fazendo dump de dados para tabela `tbl_tipousuario`
--

INSERT INTO `tbl_tipousuario` (`id_tipo`, `tipo`) VALUES
(1, 'Administrador'),
(2, 'Farmacia'),
(3, 'Cliente');
...
INSERT INTO `tbl_usuarios` (`id_usuario`, `usuario`, `senha`, `id_tipo`, `email`, `nome`) VALUES
(25, 'droga_esquina', '0192023a7bbd73250516f069df18b500', 2, 'nome@exemplo.com', 'Drogaria da Esquina'),
(27, 'admin', '0192023a7bbd73250516f069df18b500', 1, 'contato@adminitrador.com.br', 'Administrador'),
(29, 'droga_nono', '0192023a7bbd73250516f069df18b500', 2, 'nono@nono.nono', 'Drogaria Nonô'),
(30, 'campo_belo', '0192023a7bbd73250516f069df18b500', 2, 'contato@campobelo.com.br', 'Farmácia Campo Belo'),
(36, 'bruno_chagas', '0192023a7bbd73250516f069df18b500', 3, 'bruno.chagas@gmail.com', 'Bruno Chagas');
...
ALTER TABLE `tbl_clientes`
  ADD CONSTRAINT `fk_IDloginUser` FOREIGN KEY (`id_usuario`) REFERENCES `tbl_usuarios` (`id_usuario`);

--
-- Restrições para tabelas `tbl_farmacias`
--
ALTER TABLE `tbl_farmacias`
  ADD CONSTRAINT `fk_EmailUsuario` FOREIGN KEY (`email`) REFERENCES `tbl_usuarios` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `tbl_produtos`
--
ALTER TABLE `tbl_produtos`
  ADD CONSTRAINT `fk_IdCat` FOREIGN KEY (`categoria`) REFERENCES `tbl_categorias` (`id_categoria`),
  ADD CONSTRAINT `fk_IdFarm` FOREIGN KEY (`id_farmacia`) REFERENCES `tbl_farmacias` (`id_farmacia`);

--
-- Restrições para tabelas `tbl_usuarios`
--
ALTER TABLE `tbl_usuarios`
  ADD CONSTRAINT `fk_IDtipo` FOREIGN KEY (`id_tipo`) REFERENCES `tbl_tipousuario` (`id_tipo`);
