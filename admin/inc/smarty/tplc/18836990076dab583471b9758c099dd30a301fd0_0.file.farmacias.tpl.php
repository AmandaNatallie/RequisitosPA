...
<div class="row-fluid">
    <div class="span12">
        <div class="box collapsed">
            <div class="box-title">
                <h3><i class="icon-reorder"></i> Cadastro de Farmácias</h3>
                <div class="box-tool">
...
?>
                     ...
                     <div class="control-group">
                        <label class="control-label">Logotipo em Alta Resolução:</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="usuario">Usuário do painel:</label>
                        <div class="controls">
                            <div class="span12">
...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-table"></i> Gerenciamento de Farmácias</h3>
                <div class="box-tool">
                    <a data-action="collapse" href="#"><i class="icon-chevron-up"></i></a>
                    <a data-action="close" href="#"><i class="icon-remove"></i></a>
                </div>
